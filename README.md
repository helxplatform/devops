...
```
### A basic-values.yaml file for the HeLx chart
...
appstore:
  image:
    # Docker registry.
    respository: helxplatform/appstore
...
nginx:
  ingress:
    # New installations of helx should set this value to avoid needing to request an IP from cluster admins
    create: true
  service:
    serverName: # Domain name already assigned by admin.
  SSL:
    nginxTLSSecret: # SSL certs already installed by admin in your namespace.
