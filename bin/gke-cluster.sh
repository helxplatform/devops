...
CLUSTER_VERSION=${CLUSTER_VERSION-1.17.14-gke.1600}
...
NUM_POOL_NODES=${NUM_POOL_NODES-1}
...
HELX_DEVOPS_HOME=${HELX_DEVOPS_HOME-${SCRIPT_PATH}/..}
...
KUBECONFIG_DIR=${KUBECONFIG_DIR-${HELX_DEVOPS_HOME}/kubeconfigs/${PROJECT}-${CLUSTER_NAME_ENV}}
