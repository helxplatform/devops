...
export DICOMCT_USER_HOME=${DICOMCT_USER_HOME-$CLOUD_TOP_USER_HOME}
export DICOMCT_USER_NAME=${DICOMCT_USER_NAME-$CLOUD_TOP_USER_NAME}
export DICOMCT_VNC_PW=${DICOMCT_VNC_PW-$CLOUD_TOP_VNC_PW}
export DICOMGH_USER_HOME=${DICOMGH_USER_HOME-$CLOUD_TOP_USER_HOME}
export DICOMGH_USER_NAME=${DICOMGH_USER_NAME-$CLOUD_TOP_USER_NAME}
export DICOMGH_VNC_PW=${DICOMGH_VNC_PW-$CLOUD_TOP_VNC_PW}
